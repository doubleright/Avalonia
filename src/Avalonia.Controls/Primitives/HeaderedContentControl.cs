...
namespace Avalonia.Controls.Primitives
{
    ...
    public class HeaderedContentControl : ContentControl, IHeadered
    {
        ...
        protected override int VisualChildrenCount => base.VisualChildrenCount + (_headerChild is null ? 0 : 1);

        protected override ILogical GetLogicalChild(int index)
        {
            if (index == base.VisualChildrenCount && _headerChild is not null)
                return _headerChild;
